		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
			  ...
			  <li class="nav-item active">
				<a class="nav-link logoInfo" href="#" style = "color:#fff;">Edit Employee Form<span class="sr-only">(current)</span></a>
			  </li>
			</ul>
	...
	<div class="card bg1-light">
		...
		<div class="row"><div class = "col-sm mx-auto"style="max-width: 500px;">
		  <img src="images/progress1.png" style="height:120px;margin:0px;">
			...
			<form id="addform" method = "post" action = "edit_employee_step2.php">
