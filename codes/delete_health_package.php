...
<html lang="en">
  <head>
    ...
    <title>DELETE Health Package</title>
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
			  ...
			  <li class="nav-item active">
				<a class="nav-link logoInfo" href="#" style = "color:#fff;">Delete Health Package<span class="sr-only">(current)</span></a>
			  </li>
			</ul>
					...
					<div class = "row">
						<div class = "col-12">
							<div class="form-group input-group">
								...
								<input name="package_name" class="form-control" placeholder="" type="text" value = '<?php echo "$package_name";?>' readonly>
							</div>
						</div>
					</div>
					<div class = "row">
						<div class = "col-12">
							<div class="form-group input-group">
								<div class="input-group-prepend">
									<span class="input-group-text"><b>Package Desc: </b></span>
								</div>
								<input name="package_desc" class="form-control" placeholder="" type="text" value = '<?php echo "$package_desc";?>' readonly>
							</div>
						</div>
					</div>
				</div>
