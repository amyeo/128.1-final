...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    echo "POST Detected!" . "\n";
    //add to db here
    $querystr = "insert into applicant(first_name, middle_initial, last_name, full_address, sex, birthday, place_of_birth, date_submitted, phone_number, email, linkedin_profile, educational_attainment, nationality, civil_status, SSN, employment_history, applying_for, birth_cert_id) values('".$first_name."', '". $middle_initial."', '". $last_name."', '".$full_address."', '".$sex. "', '" . $birthday . "', '" . $place_of_birth . "', '" . "GETDATE()" . "', '" . $phone_number . "', '" . $email . "', '" . $linkedin_profile . "', '" . $educational_attainment . "', '" . $nationality . "', '" . $civil_status . "', '" . $SSN . "', '" . $employment_history . "', '" . $applying_for . "', '" . $birth_cert_id ."')";
