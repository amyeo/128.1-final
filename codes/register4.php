...
job_history_csv, skills_csv, target_position, user_password) VALUES ('" . $first_name . "', '" . 
...
$SSN . "', '" . $job_history_csv . "', '" . $employee_skills_csv . "', '" . $target_position . "', '" . $_POST["results_password1"]  . "')");
